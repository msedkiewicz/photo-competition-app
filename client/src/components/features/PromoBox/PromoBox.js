    ...
    <section className="promo-box animated fadeInLeft">
      <Row>
        <Col xs="12" xl="6" className="order-2 order-xl-1">
          ...
          <p className="mt-3">
            Join our community and submit your portraits. Your work will be
            judged by acclaimed photographers from all around the world.
          </p>
          <p>Showcase yourself and win enormous prizes!</p>
          <Link to="/submit">
            <Button color="primary" size="lg" className="btn-pill">
              Submit your work!
            </Button>
          </Link>
        </Col>
